...
class Product(models.Model):
    """
    Модель Product представляет продукт, который можно продавать в интернет-магазине.
    ...
    description = models.TextField(null=False, blank=True, db_index=True, verbose_name=_("Description"))
    ...
    created_at = models.DateTimeField(auto_now_add=True, verbose_name=_("Receipt date"))
    created_by = models.ForeignKey(User, on_delete=models.PROTECT, verbose_name=_("Inspector"))
    archived = models.BooleanField(default=False, verbose_name=_("Is archived"))
    preview = models.ImageField(null=True, blank=True, upload_to=product_preview_directory_path)

    def __str__(self) -> str:
        return f"{self._meta.verbose_name}_(pk={self.pk}, name={self.name!r})"
